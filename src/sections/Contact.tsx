...
import { Mail, Phone, MapPin, ExternalLink, Instagram, Facebook, Youtube, Sparkles } from "lucide-react";
...
export function Contact({ currentLang, translations }: ContactProps) {
  ...
  return (
    <section id="contact" className="bg-[#fdfcfb] py-16 px-6 md:px-12 text-stone-900">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-stretch">
          ...
          <div className="lg:col-span-5 space-y-6 flex flex-col justify-between">
            ...
            <div className="bg-white border border-stone-200/60 p-6 rounded-xl shadow-2xs space-y-6">
              ...
              <div className="space-y-4 text-xs sm:text-sm font-sans">
                ...
                <div className="flex items-start space-x-3.5">
                  ...
                  <div>
                    <span className="block text-[8px] font-mono uppercase text-stone-400 font-bold tracking-wider">Owner & Host</span>
                    <a
                    ...
                    >
                      {formatPhoneNumber(VILLA_CONFIG.contact.phone)} (WhatsApp)
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3.5">
                  ...
                  <div>
                    <span className="block text-[8px] font-mono uppercase text-stone-400 font-bold tracking-wider">Email Address</span>
                    <a
                ...
                <div className="flex items-start space-x-3.5">
                  ...
                  <div>
                    <span className="block text-[8px] font-mono uppercase text-stone-400 font-bold tracking-wider">Kasongan Presence</span>
                    <p className="font-sans text-stone-600 font-light mt-1.5 leading-relaxed text-xs sm:text-sm">
                      {VILLA_CONFIG.contact.address[currentLang]}
                    </p>
                    <a
                      href={VILLA_CONFIG.contact.googleMapsDirectionUrl}
                      target="_blank"
                      rel="noopener noreferrer"
            ...
            <div className="flex items-center justify-start space-x-3 pt-2">
              <span className="font-mono text-[9px] uppercase text-stone-400 tracking-wider font-bold">Follow Resort Journal:</span>
              <a href={VILLA_CONFIG.socials.instagram} target="_blank" rel="noopener noreferrer" className="p-2 bg-white hover:bg-gold/10 border border-stone-200 hover:border-gold text-stone-500 hover:text-gold rounded-full transition-all shadow-2xs">
                <Instagram className="h-4 w-4" />
              </a>
              <a href={VILLA_CONFIG.socials.facebook} target="_blank" rel="noopener noreferrer" className="p-2 bg-white hover:bg-gold/10 border border-stone-200 hover:border-gold text-stone-500 hover:text-gold rounded-full transition-all shadow-2xs">
                <Facebook className="h-4 w-4" />
              </a>
              <a href={VILLA_CONFIG.socials.youtube} target="_blank" rel="noopener noreferrer" className="p-2 bg-white hover:bg-gold/10 border border-stone-200 hover:border-gold text-stone-500 hover:text-gold rounded-full transition-all shadow-2xs">
          ...
          <div className="lg:col-span-7 h-full">
            <div className="bg-white border border-stone-200/60 p-4 rounded-xl shadow-2xs h-full flex flex-col justify-between">
              ...
              {/* The Iframe Map */}
              <div className="w-full h-[280px] md:h-[320px] lg:h-[350px] rounded-lg overflow-hidden border border-stone-200">
                <iframe
                  title="Sekar Sophia Villa Google Map Kasongan location"
                  src={VILLA_CONFIG.contact.googleMapsEmbedUrl}
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
