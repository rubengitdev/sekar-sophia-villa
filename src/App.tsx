...
export default function App() {
  ...
  return (
    <div id="sekar-sophia-villa-site" className="min-h-screen bg-[#fdfcfb] font-sans antialiased text-stone-900 selection:bg-gold/10 selection:text-gold">
      ...
      <footer id="global-footer" className="bg-[#f7f3ee] text-stone-800 border-t border-stone-200/60 pt-14 pb-8 px-6 md:px-12 mt-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 border-b border-stone-200 pb-10 text-center md:text-left">
            ...
            <div className="space-y-3 font-sans text-xs">
              <span className="block text-[9px] font-mono uppercase text-stone-450 tracking-widest font-bold">
                {currentLang === "en" ? "Reservations" : "Reservasi Resmi"}
              </span>
              <p className="text-stone-600 font-light">sekarsophiavilla@gmail.com</p>
              <a
