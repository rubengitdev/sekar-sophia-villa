 ...
 */
export function Lightbox({ items, currentIndex, onClose, onNavigate, currentLang }: LightboxProps) {
  useEffect(() => {
  ...
  if (currentIndex === null || !items || items.length === 0 || !items[currentIndex]) return null;
    ...
    <AnimatePresence>
      ...
      >
        ...
        <div
          ...
          className="absolute top-0 left-0 right-0 z-50 flex items-center justify-between p-4 md:p-6 text-white bg-gradient-to-b from-black/80 to-transparent"
        >
        ...
        <div
          onClick={(e) => e.stopPropagation()}
          className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-stone-950/70 to-transparent pt-12 pb-6 px-6 md:px-12 text-center"
        >
