...
export function Hero({
    ...
    return (
        <header
            id="hero-header"
            className="relative flex h-[calc(100vh-5rem)] min-h-150 md:min-h-175 w-full items-center justify-center overflow-hidden bg-cream text-stone-900"
        >
            ...
            <div className="relative z-10 mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center pt-8 pb-10">
                ...
                <div className="w-full max-w-2xl bg-cream/45 backdrop-blur-xl rounded-2xl p-6 sm:p-10 md:p-12 border border-white/60 shadow-[0_24px_60px_rgba(40,25,12,0.08)] flex flex-col items-center">
                    ...
                    >
                        <div className="flex flex-col items-center">
                            <span className="font-serif text-base sm:text-xl font-bold text-gold">
                                4.9+
                            </span>
                            <span className="font-mono text-[8px] tracking-widest text-stone-500 uppercase mt-1">
                                Superhost Rated
                            </span>
                        </div>
