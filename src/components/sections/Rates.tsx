                    ...
                    <div className="lg:col-span-6 space-y-8 text-stone-700">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-3">
                                {VILLA_CONFIG.pricing.seasons.map(
                                    (season, idx) => (
                                        <div
                                            key={idx}
                                        ...
                                        >
                                            <div>
                                                ...
                                                <span className="text-xs text-stone-500 font-light block mt-0.5">
                                                    {
                                                        translations.seasonalPeriod
                                                    }
                                                    :{' '}
                                                    {season.dates[currentLang]}
                                                </span>
                                            </div>
                                            <div className="text-right shrink-0 ml-4">
                                                ...
                                                <span className="font-mono text-[9px] text-stone-400 block uppercase tracking-wider">
                                                    /{' '}
                                                    {currentLang === 'en'
                                                        ? 'night'
                                                        : 'malam'}
                        ...
                        <div className="space-y-4">
                                ...
                                <div className="flex items-center space-x-2.5 bg-white p-2.5 rounded-lg border border-stone-200/50">
                                    ...
                                    <div>
                                        <span className="text-[10px] font-mono text-stone-500 uppercase tracking-wider">
                                            {translations.checkInLabel}
                                        </span>
                                        <span className="font-sans text-sm font-semibold text-stone-900 block mt-1">
                                            2:00 PM (WIB)
                                        </span>
                                    </div>
                                </div>
                            ...
                            <ul className="space-y-2 text-xs sm:text-sm font-sans text-stone-600 font-light">
                                {VILLA_CONFIG.pricing.rules[currentLang].map(
                                    (rule, idx) => (
                                        <li
                                            key={idx}
                                            className="flex items-start space-x-2.5 leading-relaxed"
                                        >
