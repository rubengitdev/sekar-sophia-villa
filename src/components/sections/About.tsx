...
export function About({ currentLang, translations }: AboutProps) {
    return (
        <section
            id="about"
            className="bg-cream py-16 px-6 md:px-12 text-stone-900 border-t border-stone-200/50"
        >
                    ...
                    <div className="lg:col-span-7 space-y-6">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-6 pt-4">
                            <div className="border-t border-stone-200 pt-3">
                                ...
                                <p className="font-sans text-[10px] text-stone-500 mt-1 uppercase tracking-widest font-semibold">
                                    {currentLang === 'en'
                                        ? 'Year Opened'
                                        : 'Tahun Dibuka'}
                                </p>
                        ...
                        <div className="relative aspect-square overflow-hidden rounded-xl shadow-xs border border-stone-200/60">
                            <img
                                src={getDirectImageUrl(
                                    ABOUT_PHOTOS.openConceptLiving,
                                )}
