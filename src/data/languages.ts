...
export const LANGUAGES: Record<'en' | 'id', TranslationSet> = {
    en: {
        ...
        whatsappMessagePrefill:
            "Hello Sophia! I'm interested in booking Sekar Sophia Villa. Could you please check availability?",

        heroTagline: 'A Serene Sanctuary of Art, Greenery & Soul',
        heroSubheadline:
            "Escape to Bantul's cultural heart. Experience a luxury tropical boutique villa designed for ultimate tranquility and creative living.",
        ...
        facilitiesSubtitle:
            'Every modern convenience blended seamlessly into a tropical organic escape.',

        ratesTitle: 'Investment & Seasonal Rates',
        ratesSubtitle:
            'Transparent seasonal pricing that guarantees premium comfort and exclusive direct booking privileges.',
        ...
        attractionsSubtitle:
            'Explore the magical creative community, serene beaches, and historic sights nearby.',
        distanceLabel: 'Distance',

        reviewsTitle: 'Guest Experiences',
        reviewsSubtitle:
            'Unfiltered testimonials from travellers across the globe who called our villa home.',

        contactTitle: 'Connect & Inquire',
        contactSubtitle:
            'Plan your timeless tropical getaway. Sophia is ready to welcome you.',
        ...
        specialNotesPlaceholder:
            'Special Requests / Message for Sophia (e.g., airport pickup, dietary needs)',
    ...
    id: {
        ...
        whatsappMessagePrefill:
            'Halo Sophia! Saya tertarik untuk memesan Sekar Sophia Villa. Bisa tolong cek ketersediaannya?',

        heroTagline: 'Oase Kedamaian Seni, Alam, & Jiwa',
        heroSubheadline:
            'Lepaskan penat di jantung budaya Bantul. Nikmati pengalaman menginap di vila butik tropis mewah yang dirancang untuk ketenangan total dan gaya hidup kreatif.',
        ...
        facilitiesSubtitle:
            'Setiap kenyamanan modern berpadu sempurna dalam pelarian tropis yang asri.',

        ratesTitle: 'Investasi & Tarif Musiman',
        ratesSubtitle:
            'Informasi harga transparan yang menjamin kenyamanan eksklusif dan hak istimewa pemesanan langsung.',
        ...
        attractionsSubtitle:
            'Jelajahi komunitas kreatif kerajinan seni, pantai yang sunyi, dan situs sejarah menawan di sekitar.',
        distanceLabel: 'Jarak',

        reviewsTitle: 'Kisah Pengalaman Tamu',
        reviewsSubtitle:
            'Ulasan berharga dari berbagai pelancong dari seluruh penjuru dunia.',

        contactTitle: 'Hubungi & Pesan',
        contactSubtitle:
            'Rencanakan liburan tropis Anda yang tak terlupakan. Sophia siap menyambut kedatangan Anda.',
        ...
        specialNotesPlaceholder:
            'Permintaan Khusus / Catatan untuk Sophia (misalnya, jemputan bandara, diet khusus)',
