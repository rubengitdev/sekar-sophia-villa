...
export const ATTRACTIONS: AttractionItem[] = [
    {
        ...
        googleMapsUrl:
            'https://www.google.com/maps/search/?api=1&query=Kasongan%20Ceramic%20Pottery%20Village%20Bantul%20Yogyakarta',
    },
    {
        id: 'att-kraton',
        name: {
        ...
        googleMapsUrl:
            'https://www.google.com/maps/search/?api=1&query=Kraton%20Yogyakarta%20Royal%20Palace',
    },
    {
        id: 'att-parangtritis',
        name: {
        ...
        googleMapsUrl:
            'https://www.google.com/maps/search/?api=1&query=Parangtritis%20Beach%20Yogyakarta',
    },
    {
        id: 'att-restaurants',
        name: {
        ...
        googleMapsUrl:
            'https://www.google.com/maps/search/?api=1&query=Restaurants%20near%20Kasongan%20Bantul%20Yogyakarta',
    },
];
